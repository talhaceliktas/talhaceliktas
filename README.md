# 💫 About Me:
Hi! I'm a Full Stack Software Engineer who builds scalable and high-performance web applications by bridging innovative front-end designs with robust back-end architectures. 

With solid experience in Next.js, React, and Tailwind CSS, I create dynamic, user-centric interfaces enriched by smooth GSAP animations. On the back-end, I leverage Node.js, Express, and .NET/C# to engineer secure, efficient APIs and business logic. From advanced database modeling using Prisma and PostgreSQL to exploring modern AI integrations with Python, I am equipped to manage the complete software development lifecycle. 

For me, coding is more than just work; it's where scalable architecture meets seamless user experience.
